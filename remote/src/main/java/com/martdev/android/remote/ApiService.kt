...
interface ApiService {
    ...
    @GET(SEARCH_PHOTO)
    fun searchPhotoAsync(@Query("query") query: String,
                         @Query("per_page") per_page: Int = 30):
            Deferred<Response<PhotoData>>

    @Headers("Authorization: 563492ad6f91700001000001eb6a1798e655484a977965987ff92e9d")
    @GET(CURATED_PHOTO)
    fun loadPhotoAsync(@Query("per_page") per_page: Int = 30): Deferred<Response<PhotoData>>

    @Headers("Authorization: 563492ad6f91700001000001eb6a1798e655484a977965987ff92e9d")
    @GET(SEARCH_VIDEO)
    fun searchVideoAsync(@Query("query") query: String,
                         @Query("per_page") per_page: Int = 30):
            Deferred<Response<VideoData>>

    @Headers("Authorization: 563492ad6f91700001000001eb6a1798e655484a977965987ff92e9d")
    @GET(POPULAR_VIDEO)
    fun loadVideoAsync(@Query("per_page") per_page: Int = 30): Deferred<Response<VideoData>>
}
